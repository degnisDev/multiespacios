    ...
    <>
      ...
      <section className="bg-gradient-to-br from-brand-blue via-brand-blue-light to-brand-blue pt-36 lg:pt-44 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <nav className="flex items-center gap-2 text-sm text-white/50 mb-8">
            ...
            <span>/</span>
            <span className="text-white">Carpas y Techos</span>
          </nav>
          ...
          >
            <h1 className="text-4xl md:text-5xl font-display font-extrabold text-white mb-5">
              Carpas, Pabellones{" "}
              <span className="text-brand-accent-light">y techos</span>
            </h1>
            <p className="text-lg text-white/70 leading-relaxed">
              Contamos con diferentes tipos de carpas, que varían dependiendo del
              estilo, diseño, funciones y características, incluyendo desde carpas
              simples hasta pabellones completos.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/imagenes/1_carpas/carpa_pagoda.webp"
            alt="Carpas Multiespacios"
            fill
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-5">
              ¿Necesitas una carpa a tu medida?
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://wa.me/573125575477?text=Hola%20Multiespacios%2C%20necesito%20una%20carpa%20para%20un%20evento"
                target="_blank"
                rel="noopener noreferrer"
